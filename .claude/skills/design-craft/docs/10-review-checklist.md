...
- **Total items: 50** (excluding J/K which are conditional)
- **Hard blockers (★): 7** — any single ★ fails → block merge
...
| Section | Backed by |
|---------|-----------|
| A. Color | `./02-design-system-tokens.md` § 5, `./04-typography-and-color.md` §§ 5–6, `./06-non-ai-smell.md` #1–#3 |
| B. Layout | `./03-layout-and-ia.md`, `./06-non-ai-smell.md` #4–#7 |
| C. Typography | `./02-design-system-tokens.md` § 1, `./04-typography-and-color.md` §§ 1–4, `./06-non-ai-smell.md` #8–#10 |
...
| G. Dark mode | `./04-typography-and-color.md` § 7, `./06-non-ai-smell.md` #20 |
| H. Accessibility | `./07-accessibility-and-i18n.md` |
